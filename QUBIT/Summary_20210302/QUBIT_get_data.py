...
for n_CNOT in range(min_n_CNOT, max_n_CNOT+1):
    ...
    Local_opt_file_name = 'Local_opt_neg_Q'+str(n_qubit)+'_CNOT'+str(n_CNOT)+\
                          '.npy'
...
#         f.write(str(n_connectivity_list[n])+" "+str(n_Tgate_list[n])+" "+\
#                 str(Wigner_neg_list[n])
