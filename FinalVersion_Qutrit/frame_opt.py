...
def block_frame_opt(FO_gate_list, FO_index_list, FO_gate_numbers, par0,
    ...
    INPUT - FO_gate_list:    the list of the gates in the block
            FO_index_list:   the list of qubit indices of the gates in the
                             block
            FO_gate_numbers: the gate-indices (in the full circuit) of the
                             gates in the block
            par0:            reference frame parameters
            W_gate:          quasi-probability function for gates
    '''
    par0_len = len(par0)
    ...
    # the number of different frame-parameters in the given block
...
def frame_opt(circuit, l, par0, W, **kwargs):
    ...
    INPUT - circuit: given circuit
            ...
            par0:    reference frame parameters
            W:       Quasi-probability functions (W_state, W_gate, W_meas)
    '''
    options = {'niter': 3}
